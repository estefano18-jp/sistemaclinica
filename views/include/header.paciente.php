<?php /*RUTA: sistemasclinica/views/include/header.paciente.php*/?>
<?php
session_start();
...
if (isset($_SESSION['usuario']['rol']) && $_SESSION['usuario']['rol'] !== 'PACIENTE') {
    ...
    } elseif ($_SESSION['usuario']['rol'] === 'ENFERMERO') {
        header('Location: ../include/dashboard.enfermeria.php');
    } else {
        header('Location: ../../login.php');
    }
    exit();
...
<head>
    ...
    <title>Sistema Clínica - Paciente</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="<?= $host ?>/views/include/dashboard.paciente.php">Sistema Clínica</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= $host ?>/views/include/dashboard.paciente.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Panel de Control
                        </a>

                        <!-- MENÚ PARA PACIENTES -->
                        <div class="sb-sidenav-menu-heading">Mis Servicios</div>
                        ...
                        <div class="collapse" id="collapseCitas" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="<?= $host ?>/views/citas/misCitas.php">Mis Citas Programadas</a>
                                <a class="nav-link" href="<?= $host ?>/views/citas/historialCitas.php">Historial de Citas</a>
                            </nav>
                        </div>

                        <a class="nav-link" href="<?= $host ?>/views/paciente/historiaClinica.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-file-medical"></i></div>
                            Mi Historia Clínica
                        </a>

                        <a class="nav-link" href="<?= $host ?>/views/paciente/misRecetas.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-prescription"></i></div>
                            Mis Recetas
                        </a>

                        <a class="nav-link" href="<?= $host ?>/views/paciente/misResultados.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-flask"></i></div>
                            Mis Resultados
                        </a>

                        <div class="sb-sidenav-menu-heading">Información</div>
                        <a class="nav-link" href="<?= $host ?>/views/paciente/especialidades.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-stethoscope"></i></div>
                            Especialidades
                        </a>
                        <a class="nav-link" href="<?= $host ?>/views/paciente/doctores.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-md"></i></div>
                            Nuestros Doctores
                        </a>
                        <a class="nav-link" href="<?= $host ?>/views/paciente/servicios.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-briefcase-medical"></i></div>
                            Servicios Disponibles
                        </a>

                        <div class="sb-sidenav-menu-heading">Mi Cuenta</div>
                        <a class="nav-link" href="<?= $host ?>/views/paciente/miPerfil.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>
                            Mi Perfil
                        </a>
                        <a class="nav-link" href="<?= $host ?>/views/paciente/cambiarClave.php">
